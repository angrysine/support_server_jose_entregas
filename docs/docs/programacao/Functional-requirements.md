...
| 6  | A aplicação deve ser capaz de exibir o inventário atualizado em menos de 10 segundos após a solicitação | ❔ Ainda não testado | - | - | Ainda não há um inventário para fazer o teste |
...
| 9  | O sistema deve garantir a segurança dos dados do inventário, permitindo apenas acesso autorizado | ❔ Ainda não testado | - | - | Ainda não há um inventário para fazer o teste |
| 10  | O Robô deve ser capaz de servir as páginas, em menos de 2 segundos, relacionadas ao controle do robô. | ❔ Ainda não testado | - | - | Ainda não há uma página para ser servida |
